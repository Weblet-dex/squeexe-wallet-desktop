...
set(DEX_PROJECT_NAME "squeexedex-wallet")
set(DEX_DISPLAY_NAME "SqueexeDEX Wallet")
set(DEX_MAINTENANCE_TOOL_NAME "Squeexe Wallet Maintenance Tool")
...
if (APPLE)
    set(DEX_APPDATA_FOLDER "Squeexe Wallet")
else ()
...
if (DEFINED ENV{PROJECT_QML_DIR})
    ...
    set(PROJECT_QML_DIR "${PROJECT_ROOT}/atomic_defi_design/Dex")
endif ()
